...
export type DealStage = 'PROSPECTING' | 'NEGOTIATION' | 'SETTLEMENT' | 'PAYMENT' | 'CLIENT_RETENTION';
export type Priority = 'LOW' | 'MEDIUM' | 'HIGH';
export type TaskStatus = 'TODO' | 'DOING' | 'DONE' | 'OVERDUE';
export type LeadStatus = 'NEW' | 'CONTACTED' | 'QUALIFIED' | 'LOST' | 'CONVERTED';
export type LeadSource = 'SMS' | 'EMAIL' | 'FACEBOOK' | 'GOOGLE' | 'BANNER' | 'META_ADS';
export type BroadcastStatus = 'DRAFT' | 'SENT' | 'WAITING' | 'FAILED';
export type LogType = 'NEGOTIATION' | 'SETTLEMENT' | 'PAYMENT' | 'CLIENT_RETENTION';
...
export type CalendarEventType = 'CALL_LOG_FOLLOWUP' | 'PAYMENT_DUE' | 'MEETING' | 'REMINDER';
export type AutomationType = 'BIRTHDAY' | 'PUBLIC_HOLIDAY' | 'PAYMENT' | 'PERSONAL';

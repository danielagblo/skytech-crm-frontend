...
export const LeadDetailPage = ({ leadId }: { leadId: string }) => {
  ...
  if (leadQuery.isError || !leadQuery.data)
    return (
      <EmptyState
        ...
        message="The lead may have been deleted or you may not have permission to view it."
      />
    );
  ...
  return (
    <div className="space-y-5">
      <PageHeader
        title={`${lead.firstName || "Unnamed"} ${lead.lastName || ""}`}
        description={`${lead.companyName || "No company"} · ${lead.role || "No role"}`}
      />

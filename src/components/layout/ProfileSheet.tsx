...
export const ProfileSheet = ({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="sm:max-w-[430px]">
        <SheetHeader className="border-b pb-4">
          <SheetTitle className="text-xl font-medium">My profile</SheetTitle>
        </SheetHeader>
          ...
          <div className="flex items-center gap-5 rounded-2xl bg-muted p-5">
            <div className="relative">
              ...
              <button
                ...
                className="absolute -bottom-1 -right-1 rounded-full bg-primary p-2 text-black shadow"
            ...
            <div className="min-w-0">
              ...
              <Button
                ...
                onClick={() => fileRef.current?.click()}
              >
                {upload.isPending ? "Uploading…" : "Change profile photo"}
              </Button>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between rounded-2xl border bg-card p-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Use a comfortable theme across every screen.
              </p>
            </div>
            <Button
              variant="outline"

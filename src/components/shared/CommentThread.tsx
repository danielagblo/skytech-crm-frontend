              ...
              <div className="flex gap-3">
                ...
                <div className="min-w-0 flex-1 rounded-xl bg-muted/70 p-3">
                  <div className="flex justify-between gap-3 text-xs">
                    <strong>{comment.authorName || "CRM user"}</strong>
                  ...
                  {onReply && (
                    <button
                      ...
                      className="mt-2 inline-flex items-center gap-1 text-xs font-medium text-muted-foreground"
                    >
                ...
                <div className="ml-11">
                  <button
                    ...
                    onClick={() =>
                      setOpen((state) => ({
                        ...state,
                        [comment.id]: !state[comment.id],
                      }))
                    }
                    className="mb-2 text-xs font-semibold text-green-700"
                  >
                    {open[comment.id] ? "Hide" : `Show ${replies.length}`}{" "}
